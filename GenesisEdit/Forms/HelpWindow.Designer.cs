namespace GenesisEdit.Forms
{
	partial class HelpWindow
	{
		...
		{
			System.Windows.Forms.TreeNode treeNode1 = new System.Windows.Forms.TreeNode("%IF%");
			System.Windows.Forms.TreeNode treeNode2 = new System.Windows.Forms.TreeNode("%IFMODE%");
			System.Windows.Forms.TreeNode treeNode3 = new System.Windows.Forms.TreeNode("%SPRITE%");
			System.Windows.Forms.TreeNode treeNode4 = new System.Windows.Forms.TreeNode("Macros", new System.Windows.Forms.TreeNode[] {
            treeNode1,
            treeNode2,
            treeNode3});
			System.Windows.Forms.TreeNode treeNode5 = new System.Windows.Forms.TreeNode("Macro Values");
			System.Windows.Forms.TreeNode treeNode6 = new System.Windows.Forms.TreeNode("Syntax Notation");
			...
			treeNode1.Name = "IF";
			treeNode1.Text = "%IF%";
			treeNode2.Name = "IFMODE";
			treeNode2.Text = "%IFMODE%";
			treeNode3.Name = "SPRITE";
			treeNode3.Text = "%SPRITE%";
			treeNode4.Name = "Macros";
			treeNode4.Text = "Macros";
			treeNode5.Name = "Macro Values";
			treeNode5.Text = "Macro Values";
			treeNode6.Name = "SyntaxNotation";
			treeNode6.Text = "Syntax Notation";
			treeNode7.Name = "Help";
